    ...
    <main>
        ...
        <section  class="text-xl md:text-lg max-sm:text-sm">
            <div class="conteneur_intranet">
                <div>
                    <a href="http://192.168.1.16/glpi" class="bouton_intranet">Faire une demande d'assistance</a>
                </div>

                <div>
                    <a href = "http://192.168.1.35/nextcloud" class="bouton_intranet">Accéder au cloud</a>
                </div>
